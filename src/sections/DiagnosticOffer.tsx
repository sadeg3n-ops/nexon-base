...
export function DiagnosticOffer() {
  ...
  return (
    <section id="diagnostico" className="py-24 px-6 md:px-12 lg:px-24">
              ...
              <AnimatePresence mode="wait">
                {status === 'success' ? (
                  ...
                  >
                    ...
                    <Button onClick={() => setStatus('idle')} className="bg-white text-black hover:bg-gray-100 flex gap-2 w-full sm:w-auto">
                  ...
                  >
                    ...
                    <div className="pt-2 transition-transform active:scale-[0.98]">
                      <Button 
                        ...
                        className="w-full bg-ai-blue hover:bg-blue-600 text-white py-4 font-semibold text-lg flex items-center justify-center gap-2"
                      >
