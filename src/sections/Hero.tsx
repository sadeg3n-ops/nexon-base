          ...
          >
            ...
            >
              {[
                ...
                { icon: <TrendingUp size={24} />, ...copy.hero.cards[1], color: "text-amber-400", bg: "bg-amber-400/8", border: "hover:border-amber-400/30", left: "1rem" },
                { icon: <BarChart2 size={24} />, ...copy.hero.cards[2], color: "text-ai-blue", bg: "bg-ai-blue/8", border: "hover:border-ai-blue/30", left: "2rem" },
                { icon: <Calendar size={24} />, ...copy.hero.cards[3], color: "text-emerald-500", bg: "bg-emerald-500/8", border: "hover:border-emerald-500/30", left: "3rem" },
